...
export const command: Command = {
  ...
  async execute(interaction: UserContextMenuCommandInteraction) {
    ...
    const transactionTypeMap: { [key: string]: string } = {
      ...
      draw: "抽卡",
      "game:baccarat_bet": "遊戲：百家樂下注",
      "game:baccarat_refund": "遊戲：百家樂退款",
      "game:baccarat_win": "遊戲：百家樂勝利",
      "game:blackjack_bet": "遊戲：二十一點下注",
      "game:blackjack_win": "遊戲：二十一點勝利",
      "game:dice_bet": "遊戲：骰子下注",
      "game:dice_win": "遊戲：骰子勝利",
      "game:mines_bet": "遊戲：踩地雷下注",
      "game:mines_special_reward": "遊戲：踩地雷特別獎勵",
      "game:mines_win": "遊戲：踩地雷勝利",
      "game:poker1v1_buy_in": "遊戲：單挑撲克買入",
      "game:poker1v1_settlement": "遊戲：單挑撲克結算",
      "game:slot_bet": "遊戲：拉霸下注",
      "game:slot_win": "遊戲：拉霸勝利",
      "game:spin_bet": "遊戲：輪盤下注",
      "game:spin_win": "遊戲：輪盤勝利",
      "game:tower_bet": "遊戲：爬塔下注",
      "game:tower_cashout": "遊戲：爬塔結算",
      "game:tower_win": "遊戲：爬塔勝利",
      "reward:daily": "每日獎勵",
      "reward:hourly": "每小時獎勵",
      sell_card: "賣卡",
      "stock:buy": "股票：購買",
      ...
      "trade:buy": "交易：購買",
      "trade:sell": "交易：賣出",
      transfer_receive: "收到轉帳",
      transfer_send: "送出轉帳",
      unknown: "未知",
      "wish:expand_slot": "擴充願望欄位",
      "wish:upgrade_power": "升級願望能量",
      OIL_TRANSFER: "油幣轉帳",
      GACHA_PULL: "轉蛋",
      ASSET_PURCHASE: "資產購買",
      ASSET_SALE: "資產出售",
